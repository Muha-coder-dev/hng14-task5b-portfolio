    ...
    <Motion let:motion initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }}>
      <div use:motion class="text-center max-w-4xl">
        ...
        <Motion let:motion initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6, duration: 0.8 }}>
          <div use:motion>
            <a href="https://hireme.muhammadishaq.xyz" target="_blank" class="group relative inline-flex items-center justify-center px-10 py-5 border-2 border-white bg-black hover:bg-white hover:text-black transition-all duration-300 text-lg font-medium tracking-wider overflow-hidden rounded-full">
